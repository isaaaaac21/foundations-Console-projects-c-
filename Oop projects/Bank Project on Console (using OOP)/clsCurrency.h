...
public:
    ...
    static void currencyCard(clsCurrency curr)
    {
    ...
    static float calculateCurrency(clsCurrency c1, clsCurrency c2, float amount)
    {
        float exchange =  amount / c1.Rate();

        if(c2.CurrencyCode() != "USD") exchange = exchange * c2.Rate();
